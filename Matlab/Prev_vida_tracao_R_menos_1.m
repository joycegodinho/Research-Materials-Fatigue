...
filename = 'I:\Dropbox\Projetos de Graduação\JOYCE\ANALISE2D\DADOS\V_0_12a.txt';

%% Iniciar variáveis.
NOME = 'I:\Dropbox\Projetos de Graduação\JOYCE\ANALISE2D\DADOS\V_0_12a';
...
%CARACTERIZA A CURVA DE FADIGA DO ESPÉCIME ENTALHADO EM TRAÇÃO (L versus N)
%Levantada a partir da análise de fadiga do cp com r = 0,12 mm
